...
-- Polizas --
insert into poliza (id_paciente, estado_poliza, inicio_poliza, fin_poliza) values (1,'Activa', '2020-03-26','2025-03-26');



-- Citas --
insert into appointment (id_poliza, fecha_cita, hora_cita, estado_cita, observacion_cita) values (1, '2022-08-10', '15:00:00', 'ACEPTADA', 'Paciente pasara por observacion medica.');